...
const Gallery = ({ account }) => {
  ...
  return (
    <div className="container mx-auto p-4 pt-0 md:pt-4">
      <div className="text-6xl text-white font-bold block md:hidden pt-8">ProSo</div>
      <h1 className="text-6xl pb-8 pt-8 md:pt-12 font-bold mb-4 text-neutral-700">Browse {displayTokens.length} Piece</h1> {/* Use totalSupply here */}
